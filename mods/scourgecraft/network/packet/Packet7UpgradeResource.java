...
public class Packet7UpgradeResource extends ScourgePacket {

	private int xCoord;
	private int yCoord;
	private int zCoord;
   
    public Packet7UpgradeResource(TileEntityScourgeResource par1Resource) {
    		this.xCoord = par1Resource.xCoord;
    		this.yCoord = par1Resource.yCoord;
    		this.zCoord = par1Resource.zCoord;
    }

    public Packet7UpgradeResource() { } // Be sure to always have the default constructor in your class, or the reflection code will fail!
    ...
    protected void execute(EntityPlayer player, Side side) {
            if (side.isServer()) {
            	...
            	{
            		((TileEntityScourgeResource)te).upgrade();
            	}
            } 
    }
}